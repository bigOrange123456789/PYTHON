...
for page0 in range(2):
    ...
    base_url="https://haokan.baidu.com/web/video/feed?tab=yinyue_new&act=pcFeed&pd=pc&num=20&shuaxin_id=1627287058241"
    #base_url='https://www.baidu.com/sf/vsearch?pd=video&tn=vsearch&lid=a6e229ce0001715d&ie=utf-8&wd=%E6%B5%8B%E8%AF%95&rsv_spt=7&rsv_bp=1&f=8&oq=%E6%B5%8B%E8%AF%95&rsv_pq=a6e229ce0001715d&rsv_t=c1b3tYGvo8NhCyCrG6QmbAFtIXbfIsaUR1pxQmROeMQpAmnGlGWC8GTZ%2BXxK8QrVlM03'
    #base_url="https://vd3.bdstatic.com/mda-medypd9x797iefap/1080p/cae_h264/1621034951221668219/mda-medypd9x797iefap.mp4?v_from_s=hkapp-haokan-nanjing&auth_key=1627288111-0-0-d5629764ffc03575340cab17c0ee0746&bcevod_channel=searchbox_feed&pd=1&pt=3&abtest="
    headers={
    ...
    }#导航页面SHR文件的用户代理和cookie
    # 2、发送请求-requests 模拟浏览器发送请求，获取响应数据
    response=requests.get(base_url,headers=headers) #发送get请求
