...
class Alignment:  # 基于PCA
    ...
    def compute(self):
        if self.method=="cpca":
            ...
            mat1, mean1, normal1 = self.pca(self.v1, 3)  # obj0=(obj1-mean)*mat*mat'
            mat2, mean2, normal2 = self.pca(self.v2, 3)  # obj0=obj2*mat'+mean2
    ...
    def pca(self, dataMat, topNfeat):  # topNfeat 降维后的维度
        # 去均值，将样本数据的中心点移到坐标原点
